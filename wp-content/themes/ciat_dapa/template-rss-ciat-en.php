<?php
/*
  Template Name: Custom RSS To CIAT English
 */
...
<rss version="2.0"
    ...
    <channel>
        ...
        <?php if ($_GET['cat']) query_posts( array ( 'category_name' => $_GET['cat']) );?>
          ...
          <?php if($limit != 0 && $count == $limit) break; ?>
            <item>
                ...
                foreach ($post_categories as $c) {
                    ...
                    ?>
                    <category><![CDATA[<a href="<?php echo $category_link ?>"><?php echo $cat->name?></a>]]></category>
                    <?php
                }
                ?>
                <?php
