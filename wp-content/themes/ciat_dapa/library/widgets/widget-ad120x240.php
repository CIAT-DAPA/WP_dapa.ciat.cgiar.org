...
class themedy_ad120x240_widget extends WP_Widget {
	...
	function Themedy_Ad120x240_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'themedy_ad120x240_widget', 'description' => __('A widget that allows the display and configuration of of a single 120x240 Banner.', 'framework') );

		/* Widget control settings */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad300_widget' );

		/* Create the widget */
		$this->WP_Widget( 'themedy_ad120x240_widget', __('Themedy - 120x240 Ad', 'framework'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => '',
		'ad' => get_bloginfo('stylesheet_directory')."/images/ad-120x240.png",
