...
class themedy_ad_widget extends WP_Widget {
	...
	function Themedy_Ad_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'themedy_ad_widget', 'description' => __('A widget that allows the display and configuration of 6 125x125 ads blocks.', 'framework') );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad_widget' );

		/* Create the widget */
		$this->WP_Widget( 'themedy_ad_widget', __('Themedy - 125x125 Ads', 'framework'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_bloginfo('stylesheet_directory')."/images/ad-125x125.png",
		'link1' => 'http://www.themedy.com',
		'ad2' => get_bloginfo('stylesheet_directory')."/images/ad-125x125.png",
		'link2' => 'http://www.themedy.com',
		'ad3' => '',
		'link3' => '',
		'ad4' => '',
		'link4' => '',
