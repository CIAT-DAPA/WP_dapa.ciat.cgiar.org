...
class themedy_flickr_widget extends WP_Widget {
	...
	function Themedy_FLICKR_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'themedy_flickr_widget', 'description' => __('A widget that displays your Flickr photos.', 'framework') );

		/* Widget control settings. */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'themedy_flickr_widget', __('Themedy - Flickr Photos', 'framework'), $widget_ops, $control_ops );
	}
