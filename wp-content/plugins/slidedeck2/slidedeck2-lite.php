				...
				check_ajax_referer( 'slidedeck_activate_plugin_slidedeck3' );
                               $error = 4;
                                if ( ! current_user_can( 'activate_plugins' ) ) {
                                    ...
                                    $deactivate_result = deactivate_plugins(ABSPATH.'wp-content/plugins/slidedeck2/slidedeck2-lite.php');    
                                    $activate_result = activate_plugin( ABSPATH.'wp-content/plugins/slidedeck3/slidedeck2-lite.php' );
