    ...
    <div class="wrap">
        <div id="slidedeck-upgrade-wrapper">
            ...
            <div class="addon-verification-response">
                ...
                <span>
                   <img src="https://s3-us-west-2.amazonaws.com/slidedeck-pro/addons_assets/images/slidedeck2litebanner2.png" width="100%" height="100%" alt="SlideDeck 3 Wordpress Slider in Minutes"> 
                    </span>
            </div>
        </div>
    </div>
