	    ...
	    <div class="inside">
		    <table class="form-table">
			    ...
			    <tr>
				    ...
				    <td><input type="text" name="limit" value="<?php $c_slider_limit = get_option('limit'); if(!empty($c_slider_limit)) { echo $c_slider_limit; } else { echo "200"; } ?>"></td>
			    </tr>
			    <tr>
				    <th><label for="points">More Seperator</label></th>
				    <td><input type="text" name="points" value="<?php $c_slider_points = get_option('points'); if(!empty($c_slider_points)) { echo $c_slider_points; } else { echo "Read more"; } ?>"></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
				    ...
				    <td><input type="text" name="timeout" value="<?php $c_slider_timeout = get_option('timeout'); if(!empty($c_slider_timeout)) {echo $c_slider_timeout;} else {echo "10000";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="feat_width">Set Slider Width</label></th>
				    <td><input type="text" name="feat_width" value="<?php $c_slider_width = get_option('feat_width'); if(!empty($c_slider_width)) {echo $c_slider_width;} else {echo "1000";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="feat_height">Set Slider Height</label></th>
				    <td><input type="text" name="feat_height" value="<?php $c_slider_height = get_option('feat_height'); if(!empty($c_slider_height)) {echo $c_slider_height;} else {echo "270";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="feat_bg">Set BG Color (hexadecimal)</label></th>
				    <td><input type="text" name="feat_bg" value="<?php $c_slider_bg = get_option('feat_bg'); if(!empty($c_slider_bg)) {echo $c_slider_bg;} else {echo "e0e1e2";}?>"></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
				    ...
				    <td><input type="text" name="text_width" value="<?php $c_slider_text_width = get_option('text_width'); if(!empty($c_slider_text_width)) {echo $c_slider_text_width;} else {echo "470";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="text_color">Set Text Color</label></th>
				    <td><input type="text" name="text_color" value="<?php $c_slider_text_color = get_option('text_color'); if(!empty($c_slider_text_color)) {echo $c_slider_text_color;} else {echo "9c9c9c";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="img_width">Set Image Width</label></th>
				    <td><input type="text" name="img_width" value="<?php $c_slider_img_width = get_option('img_width'); if(!empty($c_slider_img_width)) {echo $c_slider_img_width;} else {echo "500";}?>"></td>
			    </tr>
			    <tr>
				    <th><label for="img_height">Set Image Height</label></th>
				    <td><input type="text" name="img_height" value="<?php $c_slider_img_height = get_option('img_height'); if(!empty($c_slider_img_height)) {echo $c_slider_img_height;} else {echo "270";}?>"></td>
			    </tr>
		    </table>
	    </div>
